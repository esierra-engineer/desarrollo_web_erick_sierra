...
function generateTable() {
  ...
  function addGoBackButton(){
    const div = document.getElementById("div-btn-goback");
    const indexUrl = div.getAttribute("data-index-url");

    const goBackButton = document.createElement("button");
    goBackButton.setAttribute("id", "btn-go-back");
    
    //goBackButton.setAttribute("onclick", "window.location='{{url_for('index')}}'");
